 ...
 *
 */
class Chart extends HikeActiveRecord
{
	/**
	 ...
	 */
    function isActionAllowed($controller_id = null, $action_id = null, $event_id = null)
	{
		$actionAllowed = parent::isActionAllowed($controller_id, $action_id, $event_id);
		return $actionAllowed;
    }

    public function getGraphTotaalScorePerGroup( $event_id,
                                                        $group_id)
    {
    ...
    public function getGraphScoreForVragenPerGroup($event_id,
                                                   $group_id)
    {
        $criteria = new CDbCriteria;
        $criteria->condition="group_ID = $group_id AND
    ...
    public function getGraphScoreForPostenPerGroup($event_id,
                                                   $group_id)
    {
        $criteria = new CDbCriteria;
        $criteria->condition="group_ID = $group_id AND
